...
API_ID = int(environ.get('22466210', ''))
API_HASH = environ.get('API_HASH', '463ff7e54974bdc33b65f5a7468a323d')
BOT_TOKEN = environ.get('BOT_TOKEN', "6418260809:AAH99EYJsiboIoEY8-t3tTxFEn7xJ_2bghM")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '484385736').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '0').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '484385736').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "https://us-east-1.aws.data.mongodb-api.com/app/application-1-qqfoi/endpoint/data/v1")
